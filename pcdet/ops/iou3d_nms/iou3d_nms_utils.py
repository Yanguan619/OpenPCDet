...
try:
    ...
    from . import iou3d_nms_torch_native as iou3d_nms_native
    IOU3D_NMS_CUDA_ENABLED = False
    iou3d_nms_cuda = iou3d_nms_native
...
def boxes_bev_iou_cpu(boxes_a, boxes_b):
    ...
    if IOU3D_NMS_CUDA_ENABLED:
        ...
        ans_iou = iou3d_nms_native.boxes_iou_bev(boxes_a.contiguous(), boxes_b.contiguous())
...
def boxes_iou3d_gpu(boxes_a, boxes_b):
    ...
    return iou3d_nms_native.boxes_iou3d_gpu(boxes_a.contiguous(), boxes_b.contiguous())
...
def boxes_aligned_iou3d_gpu(boxes_a, boxes_b):
    ...
    return iou3d_nms_native.boxes_aligned_iou3d_gpu(boxes_a.contiguous(), boxes_b.contiguous())
...
def nms_gpu(boxes, scores, thresh, pre_maxsize=None, **kwargs):
    ...
    return iou3d_nms_native.nms_gpu(boxes, scores, thresh, pre_maxsize=pre_maxsize, **kwargs)
...
def nms_normal_gpu(boxes, scores, thresh, **kwargs):
    ...
    return iou3d_nms_native.nms_normal_gpu(boxes, scores, thresh, **kwargs)
...
def paired_boxes_iou3d_gpu(boxes_a, boxes_b):
    ...
    return iou3d_nms_native.paired_boxes_iou3d_gpu(boxes_a.contiguous(), boxes_b.contiguous())
